#  Jiho has been so successful in both the flower and grocery business that she has decided
#  to open a furniture store.
#
# Jiho has compiled a list of inventory items into a list called inventory and wants to know a few
# facts about it.
#
...
inventory = ["twin bed", "twin bed", "headboard", "queen bed", "king bed", "dresser", "dresser", "table", "table",
             ...
             "pillow"]
# Se cuenta el número de items de la lista
inventory_len = len(inventory)
print('EL número de items del inventario es : ', inventory_len)
...
#Remember, the sorted() function doesn’t change the original list —
# it creates a new list with the elements properly sorted.
# If you use sorted() you’ll have to set inventory equal to the value returned by sorted().
